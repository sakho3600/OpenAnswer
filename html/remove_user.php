...
elseif(isset($_GET['list']) && $_GET['list']==1 && !isset($_GET['q'])){
	echo display::build_confirm_box("Are you sure you want disable the user <span id=\"uName\"></span>?", "Confirm Disable");
...
if(isset($_GET['rmv']) && $_GET['rmv']==1 && is_array($info)){
	$action = $obj->remove_user($_SESSION['user_id'], $_GET['userID']);
